...
import z80Computer from '@/assets/posts/the-appeal-of-computer-architecture/z80_computer.jpeg';
import snake from '@/assets/posts/the-appeal-of-computer-architecture/snake.png';
...
<Figure
  src={z80Computer}
  alt="My Z80 computer"
  title="(I did accidentally place the LCD screen upside-down)."
/>
...
<Figure
  src={snake}
  alt="A picture of the Snake game"
  title="This is what the game looked like."
/>
