...
import obsidianNeovim from '@/assets/posts/my-note-taking-workflow/obsidian-neovim.png';
import obsidian from '@/assets/posts/my-note-taking-workflow/obsidian.png';
import tmux from '@/assets/posts/my-note-taking-workflow/tmux.png';
...
<Figure
  src={obsidianNeovim}
  alt="A screenshot of the author's note-taking workflow."
  title="This is what my screen looks like most of the time when taking notes."
/>
...
<Figure
  src={obsidian}
  alt="A screenshot of the author's Obsidian vault"
  title="This is what a note in my Obsidian vault looks like."
/>
...
<Figure
  src={tmux}
  alt="A screenshot of an example of tmux's usage"
  title="This is what my tmux might look like when I'm working on a project."
/>
